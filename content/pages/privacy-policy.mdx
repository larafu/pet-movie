...
description: Privacy policy for Pet Movie AI
created_at: 2025-10-24
---

## Introduction

Welcome to Pet Movie AI, an AI-powered video generation platform that creates cinematic pet movies from your photos and videos. At Pet Movie AI, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Pet Movie AI:
...
2. **Uploaded Content**
   - **What We Collect**: Photos and videos of your pets that you upload to create memorial videos.
   - **Purpose**: To generate AI-powered pet movies based on your content.

3. **Usage Details**
   - **What We Collect**: Information about how you use Pet Movie AI, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

4. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access Pet Movie AI, such as device type, operating system, and browser type.
...
- You retain all ownership rights to the photos and videos you upload.
- Uploaded content is used solely for the purpose of generating your pet movies.
...
- To provide services through trusted third-party partners who assist us in operating our platform, subject to confidentiality agreements.
...
**Email**: [support@petmovie.ai](mailto:support@petmovie.ai)

By using Pet Movie AI, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
