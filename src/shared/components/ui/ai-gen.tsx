...
function AIMultiModalGeneration() {
  ...
  const renderHeader = () => (
    <div className="p-4 flex items-center justify-between border-b border-border">
      <div className="flex items-center gap-3">
        <div>
          <h3 className="text-sm font-medium text-foreground">AI Multi-Modal Generation</h3>
          <p className="text-xs text-muted-foreground">Create stunning AI-generated content</p>
        </div>
      </div>
      <button
  ...
  const renderError = () =>
    error && (
      <div className="m-4 px-4 py-3 flex items-center gap-2 text-sm text-destructive bg-destructive/10 rounded-xl">
  ...
  const renderForm = () => (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 flex-1 p-4 justify-between">
      <div className="space-y-3">
        <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {promptSuggestions.map((suggestion, index) => (
                      <button
                        ...
                        className="w-full text-left p-2 text-xs hover:bg-muted rounded-md transition-colors"
                      >
                        {suggestion}
                      </button>
                    ))}
          ...
          <Textarea
            ...
            className="w-full min-h-[80px] bg-muted text-sm text-foreground placeholder:text-muted-foreground rounded-xl focus:outline-none focus-visible:ring-offset-0 focus-visible:ring-0 focus-visible:border-primary"
          />
        </div>
          ...
          <div className="space-y-3 p-3 bg-muted/50 rounded-xl">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="w-full min-h-[60px] bg-background text-xs text-foreground placeholder:text-muted-foreground rounded-xl"
              />
            </div>
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-foreground">{settings.seed || 0}</span>
              </div>
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-foreground">{settings.steps || 30}</span>
              </div>
              <Slider
      ...
      <div className="space-y-3">
        ...
        <button
          type="submit"
          className="w-full h-10 flex items-center justify-center gap-2 bg-gradient-to-r from-primary/90 to-primary hover:from-primary hover:to-primary/90 text-primary-foreground text-sm font-medium rounded-xl transition-colors self-end"
        >
  ...
  const renderSettings = () => (
    <div className="space-y-3 p-4 rounded-xl bg-muted/50">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <AspectRatio className="w-4 h-4 text-muted-foreground" />
    ...
    <div className="p-4">
          ...
          <Card className="w-full max-w-md border-0 shadow-none bg-transparent">
            <CardContent className="flex flex-col items-center gap-4 p-6">
              <div className="relative w-16 h-16">
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-transparent to-primary/10 rounded-full animate-spin-slow" />
              </div>
              ...
              <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-primary/90 to-primary transition-all duration-300 ease-linear"
      ...
      {!isLoading && (
        <div className="space-y-4">
          <div className="p-3 space-y-2 bg-muted/50 rounded-xl">
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Quality</span>
              <span className="text-foreground">{settings.resolution}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            {mode === "video" && (
              <div className="flex justify-between text-sm">
                ...
                <span className="text-foreground">00:07</span>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center justify-between gap-2">
            <button
              ...
              className="w-full h-9 flex items-center justify-center gap-2 border border-border text-foreground text-sm font-medium rounded-xl hover:bg-muted transition-colors"
            >
              Back to Settings
            </button>
            <button
              type="button"
              className="w-full h-9 flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground text-sm font-medium rounded-xl transition-colors"
            >
              Download
            </button>
          </div>
  ...
  const renderGallery = () => {
    ...
    return (
      <div className="space-y-2">
        <h4 className="text-xs font-medium text-muted-foreground">Recent Generations</h4>
  ...
  return (
    <div className="group relative overflow-hidden w-full max-w-3xl bg-card border border-border rounded-2xl transition-all duration-300 hover:shadow-lg min-h-[600px] flex flex-col justify-between gap-2">
      {renderHeader()}
